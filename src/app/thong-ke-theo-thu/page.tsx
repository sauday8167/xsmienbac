        ...
        <div className="max-w-6xl mx-auto space-y-6">
            <div className="text-center">
                <h1 className="text-3xl font-bold text-lottery-gray-800 mb-2">
                    Thống Kê Lô Tô Theo Thứ
                </h1>
                <p className="text-lottery-gray-600">
                    Phân tích tần suất xuất hiện của các cặp số vào các ngày trong tuần
                </p>
                    ...
                    {daysOfWeek.map((dayName, index) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full whitespace-nowrap transition-colors text-sm font-semibold
                                ${activeDay === index
                                    ? 'bg-lottery-red-600 text-white shadow-md'
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="card bg-green-50 border-green-200">
                            <div className="text-sm text-gray-500">Số kỳ quay</div>
                            <div className="text-2xl font-bold text-green-700">{data.daysAnalyzed} kỳ</div>
                        </div>
                        <div className="card bg-purple-50 border-purple-200">
                            <div className="text-sm text-gray-500">Phạm vi ngày</div>
                    ...
                    <div className="card">
                        <h3 className="card-header flex items-center gap-2">
                            <span>🏆 Top 10 Số Xuất Hiện Nhiều Nhất Vào {daysOfWeek[data.dayOfWeek]}</span>
                        </h3>
                    ...
                    <div className="bg-gradient-to-r from-lottery-red-600 to-lottery-red-800 rounded-xl shadow-lg p-6 text-white overflow-hidden relative">
                        ...
                        <div className="relative z-10 text-center mb-6">
                            ...
                            <p className="text-xs opacity-80 font-medium">
                                (Dựa trên tổng hợp Top 10 từ các mốc 30, 90, 180 và 365 ngày)
                            </p>
                        </div>
                        ...
                        <div className="mt-6 text-center text-[10px] opacity-70 italic border-t border-white/10 pt-4 max-w-2xl mx-auto">
                            "Thuật toán Siêu Cấp lọc ra những cặp số xuất hiện ổn định nhất trong nhiều khung thời gian khác nhau, giúp loại bỏ nhiễu và tìm ra quy luật thực sự của các con số vào ngày {daysOfWeek[data.dayOfWeek]}."
                        </div>
                    </div>
                </div>
            ) : (
