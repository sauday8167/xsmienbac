...
export default function BacNho2NgayTab({ }: Props) {
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-l-4 border-orange-500 p-6 rounded-lg">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                        <h2 className="text-2xl font-bold text-orange-700">
                            🔥 Dự Đoán Hôm Nay (Dựa Vào 2 Ngày: Hôm Kia + Hôm Qua)
                        </h2>
                        ...
                        {displayedPredictions.slice(0, 9).map(({ yesterdayPair, predictions }) => (
                            ...
                            >
                                <div className="text-sm text-gray-600 mb-2">
                                    Hôm kia có <span className={`font-bold text-base ${viewMode === 'percentage' ? 'text-orange-600' : 'text-purple-600'
                                        }`}>{yesterdayPair[0]}</span>,
                                    hôm qua có <span className={`font-bold text-base ${viewMode === 'percentage' ? 'text-orange-600' : 'text-purple-600'
                                        }`}>{yesterdayPair[1]}</span>
                                </div>
