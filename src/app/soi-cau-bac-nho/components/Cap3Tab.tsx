...
export default function Cap3Tab({ }: Props) {
    ...
    // Filter patterns - for Cap 3, we only show patterns with at least 2 appearances to reduce noise
                                            ...
                                            <tr className="bg-green-50">
                                                <td colSpan={4} className="px-4 py-4">
                                                    <div className="text-sm">
                                                        <strong className="text-green-700">Tất cả số D theo tỷ lệ:</strong>
