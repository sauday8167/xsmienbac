...
export default function NewsPage() {
    ...
    const getCategoryBadge = (cat: string) => {
        ...
        return badges[cat as keyof typeof badges] || 'badge-news';
    };
        ...
        <div className="space-y-8">
            ...
            <div className="card">
                <div className="flex flex-wrap gap-3">
                    ...
                    <button
                        onClick={() => setCategory('soi-cau')}
                        className={`btn ${category === 'soi-cau' ? 'btn-primary' : 'btn-outline'}`}
                    >
                        Soi cầu
                    </button>
                    <button
                        onClick={() => setCategory('news')}
                        className={`btn ${category === 'news' ? 'btn-primary' : 'btn-outline'}`}
                    >
                        Tin tức
                    </button>
                    <button
                        onClick={() => setCategory('analysis')}
                        className={`btn ${category === 'analysis' ? 'btn-primary' : 'btn-outline'}`}
                    >
                        Phân tích
                    </button>
                    <button
                        onClick={() => setCategory('tips')}
                        className={`btn ${category === 'tips' ? 'btn-primary' : 'btn-outline'}`}
                    >
                        Mẹo hay
                    </button>
                </div>
